...
export default function AdminAccessRequestsPage() {
  ...
  // Deep-link only (e.g. a "view this doctor's / patient's access requests"
  // link elsewhere) — no free-text ID box on this page.
  ...
  return (
    <>
      ...
      <div dir={dir} lang={locale} className="min-h-full text-[#111827]">
              ...
              {(filters.search ||
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (doctorIdFilter || patientIdFilter) clearIdentityFilters();
                  }}
        ...
        {doctorIdFilter || patientIdFilter ? (
