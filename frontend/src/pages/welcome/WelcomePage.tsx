      ...
      <section className='relative flex min-h-screen w-full justify-center sm:py-16'>
        ...
        <div className='mx-auto flex w-full max-w-[480px] flex-col items-center gap-4'>
          ...
          <div className='flex w-full justify-center'>
            <div className='mx-auto max-h-[82px] min-w-[265px] rounded-[6px] border border-[#FFFFFFCC] border-t-[1.27px] bg-[#FFFFFF99] px-3 py-1 shadow-[0px_25px_50px_-12px_#00000040] backdrop-blur'>
              <img
                src='/images/syr-health-logo.png'
                alt='LMJ Health'
                width={226}
                height={70}
                className='max-h-[60px] my-4'
                loading='eager'
              />
            </div>
          </div>
