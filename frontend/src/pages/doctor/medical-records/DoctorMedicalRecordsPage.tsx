          ...
          overlay={
            mode !== "list" ? (
              <motion.button
                ...
                className="absolute end-4 top-4 z-20 flex h-[44px] w-[44px] items-center justify-center rounded-[6px] bg-white shadow-[0_14px_24px_rgba(0,0,0,0.16)] sm:end-[24px] sm:top-[24px]"
