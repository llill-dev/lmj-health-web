...
export default function DoctorWorkSchedulePage() {
  ...
  const dayLabels: Record<ScheduleDayKey, string> = {
    Sunday: t("doctor.workSchedule.day.sunday"),
    Monday: t("doctor.workSchedule.day.monday"),
    Tuesday: t("doctor.workSchedule.day.tuesday"),
    Wednesday: t("doctor.workSchedule.day.wednesday"),
    Thursday: t("doctor.workSchedule.day.thursday"),
    Friday: t("doctor.workSchedule.day.friday"),
    Saturday: t("doctor.workSchedule.day.saturday"),
  };
  ...
  const { updateDayAsync, isLoading: isUpdatingDay } = useUpdateScheduleDay();
  const { deleteDayAsync, isLoading: isDeletingDay } = useDeleteScheduleDay();
  ...
  const [conflictData, setConflictData] = useState<ScheduleConflictData | null>(
    null,
  );
  ...
  const [isDeleteExceptionConfirmOpen, setIsDeleteExceptionConfirmOpen] =
    useState(false);
  ...
  const handleAddDay = async (values: AddDayFormValues) => {
    try {
      ...
      toast(
        ...
        {
          variant: "success",
          title: t("doctor.workSchedule.saved"),
          durationMs: 4000,
        },
      );
    } catch (err: any) {
  ...
  const handleEditDay = async (values: EditDayFormValues) => {
    try {
      ...
      toast(
        ...
        {
          variant: "success",
          title: t("doctor.workSchedule.updated"),
          durationMs: 4000,
        },
      );
    } catch (err: any) {
      ...
      if (
        ...
        setConflictData({
          ...
          nextAction:
            ...
            t("doctor.workSchedule.conflictAction"),
        });
  ...
  const confirmDeleteDay = async () => {
    ...
    try {
      ...
      toast(
        ...
        {
          variant: "success",
          title: t("doctor.workSchedule.deleted"),
          durationMs: 4000,
        },
      );
      setDayToDelete(null);
  ...
  const handleUpdateSettings = async () => {
    try {
      ...
      await refetch();
      toast(t("doctor.workSchedule.settingsSaved"), {
        variant: "success",
        title: t("doctor.workSchedule.saved"),
        durationMs: 4000,
      });
  ...
  const handleAddException = async (values: ExceptionFormValues) => {
    try {
      ...
      toast(t("doctor.workSchedule.exceptionAdded"), {
        variant: "success",
        title: t("doctor.workSchedule.saved"),
        durationMs: 4000,
      });
  ...
  const confirmDeleteException = async () => {
    ...
    try {
      ...
      await refetch();
      toast(t("doctor.workSchedule.exceptionDeleted"), {
        variant: "success",
        title: t("doctor.workSchedule.deleted"),
        durationMs: 4000,
      });
  ...
  return (
    <>
      <Helmet>
        <title>{t("doctor.workSchedule.pageTitle")}</title>
      </Helmet>

      <div dir={dir} lang={locale} className="pb-12 min-h-screen">
        <AddDayDialog
          open={isAddDayOpen}
        ...
        <ClinicAccountsBanner
          title={t("doctor.workSchedule.title")}
            ...
            >
              <div className="flex gap-3 items-center">
                ...
                <div className="font-cairo text-[13px] font-bold text-[#B42318]">
                  {t("doctor.workSchedule.loadFailed")}
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="border-b border-[#E5E7EB] bg-gradient-to-r from-[#F9FAFB] to-white px-4 py-4 sm:px-6">
              <div className="flex gap-2 items-center">
                ...
                <h2 className="font-cairo text-[16px] font-extrabold text-[#111827]">
                  {t("doctor.workSchedule.appointmentSettings")}
                </h2>
              </div>
              <p className="mt-1 font-cairo text-[12px] font-semibold text-[#98A2B3]">
                {t("doctor.workSchedule.appointmentSettingsDesc")}
              </p>
            </div>
            ...
            <div className="p-4 sm:p-6">
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                  <label className="mb-2 flex items-center gap-2 text-start font-cairo text-[13px] font-bold text-[#344054]">
                    ...
                    {t("doctor.workSchedule.durationLabel")}
                  </label>
                  <StyledSelect
                    value={String(duration)}
                    onChange={(v) => setDuration(Number(v))}
                    options={[
                      { value: "15", label: t("doctor.workSchedule.15min") },
                      { value: "30", label: t("doctor.workSchedule.30min") },
                      { value: "45", label: t("doctor.workSchedule.45min") },
                      { value: "60", label: t("doctor.workSchedule.60min") },
                    ]}
                    listboxAriaLabel={t("doctor.workSchedule.durationAria")}
                  />
                </div>
                ...
                <div>
                  <label className="mb-2 flex items-center gap-2 text-start font-cairo text-[13px] font-bold text-[#344054]">
                    <Clock className="w-4 h-4 text-primary" />
                    {t("doctor.workSchedule.gapLabel")}
                  </label>
                  <StyledSelect
                    value={String(gap)}
                    onChange={(v) => setGap(Number(v))}
                    options={[
                      { value: "0", label: t("doctor.workSchedule.noGap") },
                      { value: "5", label: t("doctor.workSchedule.5min") },
                      { value: "10", label: t("doctor.workSchedule.10min") },
                      { value: "15", label: t("doctor.workSchedule.15min") },
                    ]}
                    listboxAriaLabel={t("doctor.workSchedule.gapAria")}
                  />
                </div>
              </div>
              ...
              <div className="mt-5 flex justify-stretch sm:justify-end">
                ...
                >
                  ...
                  {isUpdatingSettings
                    ? t("doctor.workSchedule.saving")
                    : t("doctor.workSchedule.saveSettings")}
                </motion.button>
              </div>
            </div>
          </motion.section>
            ...
            <div className="flex flex-col gap-4 border-b border-[#E5E7EB] bg-gradient-to-r from-[#F9FAFB] to-white px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
              <div>
                <div className="flex gap-2 items-center">
                  ...
                  <h2 className="font-cairo text-[16px] font-extrabold text-[#111827]">
                    {t("doctor.workSchedule.workDaysHours")}
                  </h2>
                </div>
                <p className="mt-1 font-cairo text-[12px] font-semibold text-[#98A2B3]">
                  {availableTimes.length === 0
                    ? t("doctor.workSchedule.noWorkDays")
                    : locale === "ar"
              ...
              >
                ...
                {t("doctor.workSchedule.addWorkDay")}
              </motion.button>
            </div>
              ...
              {isAwaitingData ? (
                ...
                >
                  ...
                  <p className="mt-3 font-cairo text-[14px] font-bold text-[#6B7280]">
                    {t("doctor.workSchedule.noWorkDaysSet")}
                  </p>
                  <p className="mt-1 font-cairo text-[12px] font-semibold text-[#98A2B3]">
                    {t("doctor.workSchedule.addWorkDaysDesc")}
                  </p>
                </motion.div>
              ) : (
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                          ...
                          <div className="flex gap-2 self-end sm:self-start">
                            <motion.button
                              ...
                              aria-label={t("doctor.workSchedule.edit")}
                            >
                            ...
                            <motion.button
                              ...
                              aria-label={t("doctor.workSchedule.delete")}
                            >
            ...
            <div className="flex flex-col gap-4 border-b border-[#E5E7EB] bg-gradient-to-r from-[#F9FAFB] to-white px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
              <div>
                <div className="flex gap-2 items-center">
                  <Calendar className="w-5 h-5 text-primary" />
                  <h2 className="font-cairo text-[16px] font-extrabold text-[#111827]">
                    {t("doctor.workSchedule.exceptionsLeaves")}
                  </h2>
                </div>
                <p className="mt-1 font-cairo text-[12px] font-semibold text-[#98A2B3]">
                  {exceptions.length === 0
                    ? t("doctor.workSchedule.noExceptions")
                    : locale === "ar"
              ...
              >
                <Plus className="w-4 h-4" />
                {t("doctor.workSchedule.addException")}
              </motion.button>
            </div>
            ...
            <div className="p-4 sm:p-6">
              {exceptions.length === 0 ? (
                ...
                >
                  <Calendar className="mx-auto h-12 w-12 text-[#D1D5DB]" />
                  <p className="mt-3 font-cairo text-[14px] font-bold text-[#6B7280]">
                    {t("doctor.workSchedule.noExceptionsLeaves")}
                  </p>
                  <p className="mt-1 font-cairo text-[12px] font-semibold text-[#98A2B3]">
                    {t("doctor.workSchedule.addExceptionDesc")}
                  </p>
                </motion.div>
              ) : (
                <div className="space-y-3">
                      ...
                      >
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 flex-wrap">
                                <div className="font-cairo text-[14px] font-extrabold text-[#111827]">
                                  {exception.note ||
                                    t("doctor.workSchedule.exception")}
                                </div>
                                ...
                                >
                                  {!exception.slots ||
                                  exception.slots.length === 0
                                    ? t("doctor.workSchedule.closedDay")
                                    : t("doctor.workSchedule.customHours")}
                                </span>
                              </div>
                          ...
                          <motion.button
                            ...
                            type="button"
                            onClick={() =>
                              handleDeleteException(exception._id!)
                            }
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex gap-3 items-center">
                    ...
                    <h2 className="font-cairo text-[18px] font-extrabold text-[#111827]">
                      {t("doctor.workSchedule.bookingsPreview")}
                    </h2>
                  </div>
                  <input
                    type="date"
                    ...
                    <div className="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                      <div className="rounded-[12px] bg-white/70 p-4 shadow-sm">
                        <div className="flex gap-2 items-center mb-2">
                          ...
                          <h4 className="font-cairo text-[13px] font-extrabold text-[#155E75]">
                            {t("doctor.workSchedule.workDays")}
                          </h4>
                        </div>
                      ...
                      <div className="rounded-[12px] bg-white/70 p-4 shadow-sm">
                        <div className="flex gap-2 items-center mb-2">
                          <Clock className="w-4 h-4 text-primary" />
                          <h4 className="font-cairo text-[13px] font-extrabold text-[#155E75]">
                            {t("doctor.workSchedule.slotSettings")}
                          </h4>
                        </div>
                        <div className="flex gap-2 items-baseline">
                          ...
                          <span className="font-cairo text-[13px] font-semibold text-[#667085]">
                            {t("doctor.workSchedule.minPerAppointment")}
                          </span>
                        </div>
                        <p className="mt-1 font-cairo text-[11px] font-semibold text-[#667085]">
                          {locale === "ar"
                      ...
                      <div className="rounded-[12px] bg-white/70 p-4 shadow-sm">
                        <div className="flex gap-2 items-center mb-2">
                          ...
                          <h4 className="font-cairo text-[13px] font-extrabold text-[#155E75]">
                            {t("doctor.workSchedule.exceptions")}
                          </h4>
                        </div>
                        <p className="font-cairo text-[24px] font-extrabold text-primary">
                          {exceptions.length}
                        ...
                        <p className="mt-1 font-cairo text-[11px] font-semibold text-[#667085]">
                          {exceptions.length === 0
                            ? t("doctor.workSchedule.noClosedDays")
                            : locale === "ar"
                      ...
                      <div className="rounded-[12px] bg-white/70 p-4 shadow-sm">
                        <div className="flex gap-2 items-center mb-2">
                          ...
                          <h4 className="font-cairo text-[13px] font-extrabold text-[#155E75]">
                            {t("doctor.workSchedule.expectedAppointments")}
                          </h4>
                        </div>
                        <p className="font-cairo text-[24px] font-extrabold text-primary">
                          {(() => {
                            // Calculate average slots per day
                            const totalMinutesPerDay = availableTimes.reduce(
                              (sum, day) => {
                            ...
                            const avgMinutes =
                              totalMinutesPerDay / (availableTimes.length || 1);
                            const slotDuration =
                              (slotSettings?.duration || 30) +
                              (slotSettings?.gap || 5);
                            const avgSlots = Math.floor(
                              avgMinutes / slotDuration,
                            );
                        ...
                        <p className="mt-1 font-cairo text-[11px] font-semibold text-[#667085]">
                          {t("doctor.workSchedule.avgAppointments")}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 rounded-[10px] bg-primary/5 p-3 border border-primary/10">
                      <p className="font-cairo text-[12px] font-semibold text-[#155E75]">
                        <strong className="font-extrabold">
                          {t("doctor.workSchedule.tip")}
                        </strong>{" "}
                        {t("doctor.workSchedule.tipText")}
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <ConfirmDialog
        ...
        title={t("doctor.workSchedule.confirmDeleteDay")}
        description={
          locale === "ar"
        ...
        confirmText={t("doctor.workSchedule.deleteDay")}
        cancelText={t("doctor.workSchedule.cancel")}
        variant="danger"
      ...
      <ConfirmDialog
        ...
        title={t("doctor.workSchedule.confirmDeleteException")}
        description={t("doctor.workSchedule.confirmDeleteExceptionDesc")}
        confirmText={t("doctor.workSchedule.deleteException")}
        cancelText={t("doctor.workSchedule.cancel")}
        variant="warning"
