          ...
          {items.map((t) => (
            <motion.div
              ...
              className={cn(
                ...
                t.variant === "error" &&
                  "border-[#FECDD3] shadow-[0_12px_32px_rgba(244,63,94,0.1)]",
                t.variant === "info" &&
                  "border-[#BFEDEC] shadow-[0_12px_32px_rgba(15,143,139,0.12)]",
                t.variant === "warning" &&
            ...
            >
              ...
              <motion.div
                ...
                className={cn(
                  ...
                  t.variant === "error" &&
                    "bg-gradient-to-l from-[#E11D48] to-[#FB7185]",
                  t.variant === "info" &&
                    "bg-gradient-to-l from-[#0B7C78] to-[#2DD4BF]",
                  t.variant === "warning" &&
