...
export default function DoctorTablePagination({
  ...
  return (
    <section className="flex items-center justify-between rounded-[12px] border border-[#EEF2F6] bg-white px-6 py-4 shadow-[0_14px_30px_rgba(0,0,0,0.06)]">
      <div className="font-cairo text-[12px] font-bold text-[#667085]">
        الصفحة {page} من {safeTotalPages}
      </div>
