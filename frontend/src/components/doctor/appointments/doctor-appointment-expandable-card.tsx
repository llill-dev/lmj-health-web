  ...
  return (
    <div className='flex items-start gap-3 border-b border-[#F2F4F7] py-3 last:border-b-0'>
      ...
      <div className='min-w-0 flex-1 text-right'>
        ...
        <div className='mt-0.5 font-cairo text-[14px] font-bold text-[#101828]'>
          {value}
        </div>
      </div>
    </div>
        ...
        <div className='flex items-start justify-between gap-3'>
          <div className='flex min-w-0 flex-1 items-start gap-3'>
            ...
            <div className='min-w-0 flex-1 space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                <span className='inline-flex h-9 items-center gap-1.5 rounded-full border border-primary bg-white px-3 font-cairo text-[12px] font-extrabold text-primary'>
          ...
          <div className='flex shrink-0 flex-col items-center gap-2 sm:flex-row sm:items-start'>
            ...
            <button
              ...
              aria-label={
                expanded ? 'طي التفاصيل' : 'عرض التفاصيل الكاملة'
              }
              onClick={onToggle}
        ...
        >
          <div className='min-h-0 overflow-hidden'>
            <div className='mt-4 border-t border-[#EEF2F6] pt-4'>
              <div className='rounded-lg border border-[#EEF2F6] bg-[#FAFBFC] px-3'>
                <DetailRow
                  icon={Calendar}
                  label='التاريخ'
                  value={detailDate}
