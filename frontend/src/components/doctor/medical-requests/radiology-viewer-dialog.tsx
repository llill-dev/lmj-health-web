...
export function RadiologyViewerDialog({
  ...
  return (
    <MedicalRequestModalShell
      open={open}
      onClose={onClose}
      title={t('doctor.medicalRequests.table.menuRadiologyViewer')}
      ...
      <div className="space-y-5">
          ...
          subtitle={
            <>
              <span className="font-extrabold text-[#344054]">
                {t('doctor.medicalRequests.dialog.imageLabel')}
              </span>{' '}
        ...
        <section className="text-start">
          <div className="mb-2 flex items-center justify-end gap-2 font-cairo text-[13px] font-extrabold text-[#111827]">
            <span>{t('doctor.medicalRequests.dialog.reportTitle')}</span>
        ...
        <div className="flex items-center justify-between gap-3 rounded-[8px] bg-[#E6F4F3] px-4 py-3">
          <button
            ...
            aria-label={t('doctor.medicalRequests.dialog.downloadFileAria')}
          >
