          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                ...
                aria-label={t("doctor.consultations.dismiss.close")}
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <textarea
              ...
              placeholder={t("doctor.consultations.dismiss.placeholder")}
            ...
            <div className="mt-4 flex gap-3">
              ...
              >
                {t("doctor.consultations.dismiss.cancel")}
              </button>
              <button
                type="button"
              ...
              >
                ...
                {t("doctor.consultations.dismiss.confirm")}
              </button>
            </div>
          </motion.div>
        </Dialog.Content>
