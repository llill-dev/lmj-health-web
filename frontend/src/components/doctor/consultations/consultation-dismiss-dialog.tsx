  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-[10000] w-[min(92vw,440px)] -translate-x-1/2 -translate-y-1/2 rounded-[14px] border border-[#E5E7EB] bg-white p-6 shadow-[0_24px_48px_rgba(0,0,0,0.18)] outline-none">
          <motion.div
