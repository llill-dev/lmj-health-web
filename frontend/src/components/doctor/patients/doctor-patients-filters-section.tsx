...
export default function DoctorPatientsFiltersSection({
  ...
  return (
    <section
      ...
      aria-label={t("doctor.patientsFiltersSection.title")}
    >
      <div className="border-b border-[#EEF2F6] bg-gradient-to-l from-primary/[0.07] via-[#F8FAFC] to-white px-5 py-4 sm:px-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex gap-3 items-start sm:items-center">
            ...
            <div className="min-w-0 text-start">
              <h2 className="font-cairo text-[16px] font-black leading-tight text-[#111827] sm:text-[17px]">
                {t("doctor.patientsFiltersSection.title")}
              </h2>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-2 justify-end items-center">
            ...
            >
              {t("doctor.patientsFiltersSection.clearFilters")}
            </button>
            ...
            >
              ...
              <span className="font-extrabold text-[#667085]">{t("doctor.patientsFiltersSection.results")}</span>
            </output>
          </div>
        </div>
      </div>
          ...
          <div className="grid flex-1 grid-cols-1 gap-3 min-w-0 sm:grid-cols-2 lg:grid-cols-3">
            <div className="min-w-0 sm:col-span-2 lg:col-span-1">
              ...
              >
                ...
                {t("doctor.patientsFiltersSection.diagnosisLabel")}
              </label>
              <input
                id="doctor-patients-diagnosis"
                type="text"
                placeholder={t("doctor.patientsFiltersSection.diagnosisPlaceholder")}
            ...
            <div className="relative min-w-0">
              ...
              >
                {t("doctor.patientsFiltersSection.accountStatusLabel")}
              </label>
              <StyledSelect
                ...
                options={[
                  { value: "all", label: t("doctor.patientsFiltersSection.accountStatus.all") },
                  { value: "active", label: t("common.active") },
                  { value: "temporary", label: t("doctor.patientsFiltersSection.temporary") },
                  { value: "suspended", label: t("doctor.patientsFiltersSection.accountStatus.suspended") },
                ]}
                listboxAriaLabel={t("doctor.patientsFiltersSection.accountStatusLabel")}
              />
            </div>
            ...
            <div className="relative min-w-0 sm:col-span-2 lg:col-span-1">
              <label
                ...
                className="mb-2 block font-cairo text-[11px] font-extrabold text-[#667085]"
              >
                {t("doctor.patientsFiltersSection.relationshipLabel")}
              </label>
              <StyledSelect
                ...
                options={[
                  { value: "all", label: t("doctor.patientsFiltersSection.relationship.all") },
                  { value: "full-access", label: t("doctor.patientsFiltersSection.relationship.fullAccess") },
                  { value: "linked-only", label: t("doctor.patientsFiltersSection.relationship.linkedOnly") },
                  { value: "temporary", label: t("doctor.patientsFiltersSection.temporary") },
                  { value: "access-pending", label: t("doctor.patientsFiltersSection.relationship.pending") },
                  { value: "active-encounter", label: t("doctor.patientsFiltersSection.relationship.activeEncounter") },
                  { value: "restricted", label: t("doctor.patientsFiltersSection.relationship.restricted") },
                  {
                    value: "relationship-indeterminate",
                    label: t("doctor.patientsFiltersSection.relationship.indeterminate"),
                  },
                ]}
                listboxAriaLabel={t("doctor.patientsFiltersSection.relationshipLabel")}
              />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-dashed border-[#E5E7EB] bg-[#FAFBFC]/90 px-4 py-4 sm:px-5">
          <div className="flex flex-wrap gap-2 items-center mb-3 text-start">
            ...
            <span className="font-cairo text-[12px] font-extrabold text-[#344054]">
              {t("doctor.patientsFiltersSection.dateRangeLabel")}
            </span>
          </div>
          <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-end sm:gap-5">
            <div className="flex min-w-[200px] flex-1 flex-col gap-1.5 sm:max-w-xs">
              <span className="font-cairo text-[10px] font-extrabold uppercase tracking-wide text-[#667085]">
                {t("doctor.patientsFiltersSection.fromDate")}
              </span>
              <input
                type="date"
                value={filters.from}
            ...
            <div className="flex min-w-[200px] flex-1 flex-col gap-1.5 sm:max-w-xs">
              <span className="font-cairo text-[10px] font-extrabold uppercase tracking-wide text-[#667085]">
                {t("doctor.patientsFiltersSection.toDate")}
              </span>
              <input
                type="date"
                value={filters.to}
