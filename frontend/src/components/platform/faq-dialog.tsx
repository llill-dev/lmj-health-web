...
export function FaqDialog({
  ...
  const { items, isAwaitingData } = usePlatformFaqContent(locale);

  return (
    <PlatformModalShell open={open} onClose={onClose} title={t('platform.faq.title')}>
      {isAwaitingData ? (
