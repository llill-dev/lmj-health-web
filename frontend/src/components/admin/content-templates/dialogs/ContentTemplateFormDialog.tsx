...
const fieldSchema = z.object({
  key: z
    ...
    .regex(/^[a-zA-Z][a-zA-Z0-9_]*$/, 'المفتاح: حروف لاتينية وأرقام وشرطة سفلية'),
...
const parentTypeOptions: { value: AdminContentTemplateParentType; label: string }[] =
  [
...
function templateToForm(template: AdminContentTemplate): FormValues {
  ...
  return {
    ...
    fields: (template.fields ?? []).map((f) => {
      ...
      const allowed = ['text', 'textarea', 'number', 'date', 'boolean', 'select'];
      return {
        key: f.key ?? '',
        label: rawLabel,
                        ...
                        {fields.map((row, index) => (
                          ...
                          >
                            <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                              ...
                              <DoctorProfileFormField label='التسمية (اختياري)'>
                                <input
                            ...
                            <div className='mt-3 flex flex-wrap items-end gap-3'>
                              <div className='min-w-[180px] flex-1'>
                                <DoctorProfileFormField label='النوع'>
                                  <Controller
