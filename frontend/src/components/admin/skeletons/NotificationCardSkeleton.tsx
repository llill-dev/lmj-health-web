...
export function NotificationCardSkeleton({ index = 0 }: { index?: number }) {
  const delay = createStaggeredDelay(index);
  return (
    <div
      className="rounded-[14px] border border-[#EAECF0] bg-white p-5 shadow-[0_4px_16px_rgba(0,0,0,0.04)] md:p-6"
