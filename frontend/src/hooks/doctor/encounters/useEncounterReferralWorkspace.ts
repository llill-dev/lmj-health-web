...
import { consumeReferralTemplateDraft } from '@/lib/doctor/templates/consumeTemplateDraft';
import {
  resolveEncounterOrderStatusLabel,
} from '@/lib/doctor/encounters/encounterOrderCategories';
import { loadEncounterReferralOrderForWorkspace } from '@/lib/doctor/encounters/encounterOrderLoad';
import {
  ReferralFormSubmitError,
  assertReferralFormValid,
} from '@/lib/doctor/referrals/referralFormSchema';
import { resolveReferralServerFeedback } from '@/lib/doctor/referrals/referralFormErrors';
import {
  mapReferralPriorityFromApi,
  mapReferralPriorityToApiUrgency,
} from '@/lib/doctor/referrals/referralPriority';
import {
...
import type { ReferralFormState, ReferralPriority } from '@/lib/doctor/referrals/referralFormSchema';
