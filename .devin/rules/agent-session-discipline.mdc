...
For every backend-related task, ALWAYS read `docs/**/*` before writing or modifying any code.
Never implement an endpoint without verifying its contract in `docs/**/*`.
...
4. Treat docs/**/* as the canonical backend contract.
...
If the frontend conflicts with docs/**/*,
