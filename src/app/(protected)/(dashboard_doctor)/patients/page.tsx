      ...
      <section className='rounded-[16px] bg-[#16C5C0] px-6 py-5 shadow-[0_24px_60px_rgba(0,0,0,0.18)]'>
        <div className='flex items-start justify-between'>
          ...
          <div className='grid w-[520px] grid-cols-2 gap-4'>
            <div className='rounded-[14px] bg-white/15 px-5 py-4'>
      ...
      <section className='mt-6 rounded-[16px] border border-[#E5E7EB] bg-white p-4 shadow-[0_14px_30px_rgba(0,0,0,0.06)]'>
        <div className='relative'>
          <input
            ...
            className='h-[40px] w-full rounded-[12px] border border-[#E5E7EB] bg-white ps-11 pe-4 font-cairo text-[13px] font-semibold text-[#111827] outline-none placeholder:font-cairo placeholder:font-medium placeholder:text-[#98A2B3]'
          />
        ...
        <div className='mt-3 grid grid-cols-3 gap-3'>
          <button
            type='button'
            className='h-[34px] rounded-[12px] bg-[#16C5C0] font-cairo text-[12px] font-extrabold text-white shadow-[0_14px_24px_rgba(22,197,192,0.25)]'
          >
            الكل
          </button>
          <button
            type='button'
            className='h-[34px] rounded-[12px] bg-[#F2F4F7] font-cairo text-[12px] font-extrabold text-[#667085]'
          >
            نشط
          </button>
          <button
            ...
            >
              <div className='flex items-start justify-between px-6 pb-4 pt-5'>
                <div className='flex items-start gap-3'>
                  <div className='flex h-[44px] w-[44px] items-center justify-center rounded-[14px] bg-[#16C5C0] text-white shadow-[0_12px_25px_rgba(22,197,192,0.35)]'>
                ...
                <div className='flex items-center gap-3'>
                  <button
                    type='button'
                    className='flex h-9 w-9 items-center justify-center rounded-full border border-[#E5E7EB] text-[#667085]'
                    aria-label='فتح'
                  >
              ...
              <div className='px-6 pb-4'>
                <div className='grid grid-cols-3 gap-3'>
                  <div className='rounded-[14px] bg-[#EFFFFE] px-4 py-3 text-center'>
                  ...
                  <div className='rounded-[14px] bg-[#F0FDF4] px-4 py-3 text-center'>
                  ...
                  <div className='rounded-[14px] bg-[#EFF6FF] px-4 py-3 text-center'>
                ...
                <div className='mt-4 rounded-[14px] bg-[#F9FAFB] px-4 py-3'>
                ...
                <div className='mt-4 grid grid-cols-2 gap-4'>
                  <button
                    type='button'
                    className='flex h-[42px] items-center justify-center gap-2 rounded-[14px] border border-[#16C5C0] bg-white font-cairo text-[13px] font-extrabold text-[#16C5C0]'
                  >
                  ...
                  <button
                    type='button'
                    className='flex h-[42px] items-center justify-center gap-2 rounded-[14px] bg-[#16C5C0] font-cairo text-[13px] font-extrabold text-white shadow-[0_18px_40px_rgba(22,197,192,0.28)]'
                  >
